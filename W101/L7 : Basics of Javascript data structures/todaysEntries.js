...
function todaysEntries(entries) {
	currentDate=entries[0].date.slice(0,10)
	names= entries.filter(entry => entry.date.slice(0,10)===currentDate).map(entry => entry.name)
	console.log(names.join())
	};

module.exports = todaysEntries([{ name: "Harry" , date: "2022-04-01T02:53:42+05:30" }, { name: "Hermione" , date: "2022-04-02T02:53:42+05:30" }, { name: "Ron" , date: "2022-04-01T03:53:42+05:30" }]);
